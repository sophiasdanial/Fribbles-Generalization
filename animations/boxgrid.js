//declaring variables
  ...
  function addCount(buttonid) {
    ...
    if (correct){
      addpicture();
      correctcounter += 1;
      document.getElementById("counter").innerHTML = "Example counter: (" + (3 + correctcounter) + ")";
    }
    if (correct) {
      document.getElementById(buttonid).src = "https://sophiasdanial.github.io/Fribbles-Generalization/images/tick.png";
    }
    else {
      document.getElementById(buttonid).src = "https://sophiasdanial.github.io/Fribbles-Generalization/images/cross.png";
    }
  }
